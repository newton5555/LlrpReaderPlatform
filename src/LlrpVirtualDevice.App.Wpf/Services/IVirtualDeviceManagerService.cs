...
public interface IVirtualDeviceManagerService : IAsyncDisposable
{
    ...
    IVirtualLlrpDeviceHost? GetHost(string instanceId);
    Task<IVirtualLlrpDeviceHost> CreateOrUpdateHostAsync(VirtualDeviceInstanceConfig config, CancellationToken cancellationToken = default);
