...
7. ⬜ **阶段 F：现场验证收口**（自动化完成，现场待办）——本地 SDK 与 NuGet 2.0.5 双模式 build/test 全绿；R420、标准 Reader、Zebra 现场剩余项按 [真机验收运行手册](development/hardware-validation-runbook.md) 逐项标定；设备矩阵与文档持续回填。
