...
> 当前软件基线（2026-08-28）：Release 构建 0 警告/0 错误，自动化测试 385 项全绿。该数字只代表平台代码回归，不替代下方各设备的现场证据；报文级 Virtual Device Manager UI 已完成首版，但不改变真实 Reader 的兼容性等级。
