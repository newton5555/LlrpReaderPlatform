...
> 当前软件基线（2026-08-19）：Release 构建 0 警告/0 错误，自动化测试 382 项全绿。该数字只代表平台代码回归，不替代下方各设备的现场证据；报文级 Virtual Device Manager UI 已完成首版，但不改变真实 Reader 的兼容性等级。
...
> 上一段的 368 项是阶段性记录；当前自动化基线为 382 项，分项见[测试策略](../development/testing-strategy.md)。
